...
public class JobServiceImpl implements JobService{
	 ...
	 */
	@Override
	public boolean scheduleDropboxCronJob(Job job,Class<? extends QuartzJobBean> jobClass, Date date, String cronExpression, FetchRequest fetchRequest) {
		System.out.println("Request received to scheduleJob");

		String jobKey = ""+job.getId();
		String groupKey = "DropboxGroup";	
		String triggerKey = ""+job.getId();		

		JobDetail jobDetail = JobUtil.createDropboxFetchJob(jobClass, false, context, jobKey, groupKey,job, fetchRequest);
